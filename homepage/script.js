...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("p", null, "I am ", React.createElement("a", { href:"mailto:s.singh.3@research.gla.ac.uk?subject=Hi !!"}, "Shashwat Singh"), " Ph.D. at ", React.createElement("a", { href: "https://www.gla.ac.uk/" }, "University of Glasgow"), " in ", React.createElement("a", { href: "https://www.gla.ac.uk/schools/physics/" }, "School of Physics and Astronomy"), ". I am a member of the ", React.createElement("a", {href:"https://www.gla.ac.uk/schools/physics/research/groups/igr/"}, "IGR"), " group, where we are unveiling cosmic mysteries using ", React.createElement("a", { href: "https://medium.com/@SSingh087/gravitational-waves-a-non-mathematical-introduction-i-129c4dda1cdc" }, "Gravitational Waves"), ", which is the primary area of my research. I work under the supervision of ", React.createElement("a", { href: "https://cplberry.com/" }, "Dr. Chritopher Berry"), " and ", React.createElement("a", { href: "https://www.physics.gla.ac.uk/igr/index.php?L1=members&L2=member&name=jveitch"}, "Dr. John Veitch"), " focusing on revealing the family of massive black holes with LISA. Feel free to explore my ", React.createElement("a", { href: "./research/index.html"}, "research")," and ", React.createElement("a", { href: "mailto:s.singh.3@research.gla.ac.uk?subject=Inquiry on research"}, "nudge me"), " in any case."),

      React.createElement("p", null, "Beyond the academic realm, I co-founded ", React.createElement("a", { href: "https://www.bosex.org/"}, "Bose.X"), ", a research group dedicated to supporting and promoting undergraduate research. Recently I started a blog/educational channel - ", React.createElement("a", { href: "./nonac/grawitty/Grawitty-loader.html"}, "GRA-WITTY"), " where I aim to share latest updates on astrophysics and explain academic articles. If you would like to contribute to this endeavor feel free to ", React.createElement("a", { href: ".mailto:s.singh.3@research.gla.ac.uk?subject=Inquiry on Grawitty"}, "contact"),  " me."),
      ...
      cursorGrabbed && "Information lost",
